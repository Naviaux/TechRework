...
function NewRaycastWeaponBase:reload_speed_multiplier()
	...
	multiplier = multiplier + (1 - managers.player:upgrade_value("weapon", "drop_reload", 1))
	multiplier = multiplier + (1 - managers.player:team_upgrade_value("weapon", "drop_reload", 1))
